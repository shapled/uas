create table uas_app (
  ...
  desc varchar(1024) comment '应用描述',
  status int default 0 comment '状态，0 启用，1 禁用，2 删除',
  created_by bigint not null comment '创建者 id',
  created_at datetime default CURRENT_TIMESTAMP comment '创建时间',
  updated_at datetime default CURRENT_TIMESTAMP on update set CURRENT_TIMESTAMP comment '更新时间',
...
create table uas_role (
  ...
  desc varchar(1024) comment '角色描述',
  permission_ids json default '[]' comment '角色对应的权限 id 列表',
  status int default 0 comment '状态，0 启用，1 禁用，2 删除',
  created_by bigint not null comment '创建者 id',
  created_at datetime default CURRENT_TIMESTAMP comment '创建时间',
  updated_at datetime default CURRENT_TIMESTAMP on update set CURRENT_TIMESTAMP comment '更新时间'
...
create table uas_permission (
  ...
  desc varchar(1024) comment '权限描述',
  status int default 0 comment '状态，0 启用，1 禁用，2 删除',
  created_by bigint not null comment '创建者 id',
  created_at datetime default CURRENT_TIMESTAMP comment '创建时间',
  updated_at datetime default CURRENT_TIMESTAMP on update set CURRENT_TIMESTAMP comment '更新时间',
...
create table uas_role_permissoin (
  id bigint not null auto_increment primary key comment '主键 id',
...
create table uas_user (
  ...
  extra json default '{}' comment '其他字段',
